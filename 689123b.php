        ...
        <div class="header" style="background-color: #4D148C;">
                <div class="menu">
                        <div class="submenu" style="padding-left:400px;">
                                 <button class="dropbtn"><a href="689123.php" style="color:white;">Manager Main</a></button>
                        </div>
                        <div class="submenu">
                        ...
                        <div class="submenu">
                         ...
                         <br><br>
                <span id="info">
                        <iframe title="Report Section" width="100%" height="804" src="https://app.powerbi.com/view?r=eyJrIjoiZTc5MjA1MzMtZGMyMC00NGRlLTlmYTgtNzA0OWQxMjMxYmJhIiwidCI6IjUyOTM0M2ZhLWU4YzgtNDE5Zi1hYjJlLWE3MGMxMDAzODgxMCIsImMiOjZ9" frameborder="0" allowFullScreen="true"></iframe>
                </span>
