        ...
        <div class="header" style="background-color: #4D148C;">
                <div class="menu">
                        <div class="submenu" style="padding-left:400px;">
                                 <button class="dropbtn"><a href="338590.php" style="color:white;">Manager Main</a></button>
                        </div>
                        <div class="submenu">
                        ...
                        <div class="submenu">
                         ...
                         <br><br>
                <span id="info">
                <iframe title="Report Section" width="100%" height="804" src="https://app.powerbi.com/view?r=eyJrIjoiYjFjZTRmN2MtMzI5Yi00ZGVjLTlhZmUtNzMxNzQ2MDBkNmEyIiwidCI6IjUyOTM0M2ZhLWU4YzgtNDE5Zi1hYjJlLWE3MGMxMDAzODgxMCIsImMiOjZ9" frameborder="0" allowFullScreen="true"></iframe>
