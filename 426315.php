...
<title>426315 Manager Portal</title>
        ...
        <div class="header" style="background-color: #4D148C;">
                <div class="menu">
                        <div class="submenu" style="padding-left:400px;">
                                 <button class="dropbtn"><a href="426315b.php" style="color:white;">Job Type Chart</a></button>
                        </div>
                        <div class="submenu">
                        ...
                        <div class="submenu">
                         ...
                         <br><br>
                <span id="info">
                <iframe title="Report Section" width="100%" height="804" src="https://app.powerbi.com/view?r=eyJrIjoiNjI5YmExNzktY2M0MS00Njc0LTg0NzctNTk2OTBkNDBlNjY0IiwidCI6IjUyOTM0M2ZhLWU4YzgtNDE5Zi1hYjJlLWE3MGMxMDAzODgxMCIsImMiOjZ9" frameborder="0" allowFullScreen="true"></iframe>
                </span>
